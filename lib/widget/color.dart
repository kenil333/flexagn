...
class AppColor{
  ...
  static const Color whiteback = Color(0xffF2F6FF);
  static const Color blue = Color(0xff1452CA);
  static const Color yellow = Color(0xffFFDC00);
  static const Color white = Color(0xffFFFFFF);
  static const Color orangefont = Color(0xffF76F3B);
  static const Color orangecont = Color(0xffFFB100);
}